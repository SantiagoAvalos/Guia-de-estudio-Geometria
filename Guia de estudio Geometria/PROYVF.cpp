...
void Obj3()
{
int cont1c=0,cont2i=0,x,a,b,a1,b1,c1,r;
float c;
gotoxy(30,5);printf("TEOREMA DE PITAGORAS Y SUS APLICACIONES.");
gotoxy(5,7);printf("En todo triangulo rectangulo el cuadrado que se puede construir en la hipotenusa es igual");
gotoxy(5,8);printf("a la suma de los cuadrados que se puede construir en los cuadrados que pueden construir en");
gotoxy(5,9);printf("los catetos de dicho triangulo(cateto mayor y cateto menor).");
gotoxy(5,10);printf("Ejemplo:");
gotoxy(5,10);printf("inserte valores para el ejemplo.");
//triangulo rectangulo
gotoxy(45,12);printf("*");
gotoxy(45,13);printf("*  *");
gotoxy(45,14);printf("*      *");
gotoxy(45,15);printf("************");
gotoxy(46,14);printf("a'");
//Termina
gotoxy(65,12);printf("o");
gotoxy(60,13);printf("<a=90");
gotoxy(49,16);printf("a=");
gotoxy(41,13);printf("b=");
gotoxy(50,13);printf("c=");
gotoxy(51,16);scanf("%i",&a);
gotoxy(43,13);scanf("%i",&b);
gotoxy(5,18);printf("Datos:");
gotoxy(5,19);printf("cm=a=%i",a);
gotoxy(5,20);printf("CM=b=%i",b);
gotoxy(5,21);printf("Incognita:");
gotoxy(5,22);printf("Hip=c=?");
gotoxy(5,23);printf("Formula:");
gotoxy(5,24);printf("c^2=a^2+b^2");
gotoxy(50,18);printf("solucion:");
gotoxy(53,19);printf("________");
gotoxy(50,20);printf("c=Va^2+b^2'");
gotoxy(53,21);   printf("____________");
gotoxy(50,22);printf("c=V(%i)^2+(%i)^2'",a,b);
a=a*a;
b=b*b;
gotoxy(53,23);   printf("____________");
gotoxy(50,24);printf("c=V(%i)^2+(%i)^2'",a,b);
c=a+b;
gotoxy(73,20);   printf("__");
gotoxy(70,21);printf("c=V%.2f'",c);
c=sqrt(c);
gotoxy(70,22);printf("c=%.2f",c);
for(x=0;x<=30000;x++)
{
gotoxy(5,25);
printf("");
}
gotoxy(52,13);printf("%.2f",c);
gotoxy(53,25);printf("Presione cualquier tecla para continuar...");
getch();
clrscr();
system("color 0B");
...
gotoxy(30,5);printf("TEOREMA DE PITAGORAS Y SUS APLICACIONES.");
gotoxy(45,6);printf("EJERCICIOS");
gotoxy(5,7);printf("Instrucciones:obten lo siguiente con teorema de pitagoras(enteros).");
srand(time(NULL));
a1=rand()%11;
b1=rand()%11;
gotoxy(8,8);   printf("____________");
gotoxy(5,9);printf("c=V(%i)^2+(%i)^2'=",a1,b1);
gotoxy(22,9);scanf("%i",&r);
c1=sqrt((a1*a1)+(b1*b1));
if(r==c1)
{
system("color 0A");
gotoxy(80,9);printf("correcto");
cont1c=cont1c+1;
}
else
{
system("color 0C");
gotoxy(80,9);printf("incorrecto");
cont2i=cont2i+1;
}
for(x=0;x<=30000;x++)
{
...
a1=rand()%11;
b1=rand()%11;
gotoxy(8,10);   printf("____________");
gotoxy(5,11);printf("c=V(%i)^2+(%i)^2'=",a1,b1);
gotoxy(22,11);scanf("%i",&r);
c1=sqrt((a1*a1)+(b1*b1));
if(r==c1)
{
system("color 0A");
...
a1=rand()%11;
b1=rand()%11;
gotoxy(8,12);   printf("____________");
gotoxy(5,13);printf("c=V(%i)^2+(%i)^2'=",a1,b1);
gotoxy(22,13);scanf("%i",&r);
c1=sqrt((a1*a1)+(b1*b1));
if(r==c1)
{
system("color 0A");
...
a1=rand()%11;
b1=rand()%11;
gotoxy(8,14);   printf("____________");
gotoxy(5,15);printf("c=V(%i)^2+(%i)^2'=",a1,b1);
gotoxy(22,15);scanf("%i",&r);
c1=sqrt((a1*a1)+(b1*b1));
if(r==c1)
{
system("color 0A");
gotoxy(80,15);printf("correcto");
cont1c=cont1c+1;
}
else
{
system("color 0C");
gotoxy(80,15);printf("incorrecto");
cont2i=cont2i+1;
}
for(x=0;x<=30000;x++)
{
...
a1=rand()%11;
b1=rand()%11;
gotoxy(8,16);   printf("____________");
gotoxy(5,17);printf("c=V(%i)^2+(%i)^2'=",a1,b1);
gotoxy(22,17);scanf("%i",&r);
c1=sqrt((a1*a1)+(b1*b1));
if(r==c1)
{
system("color 0A");
gotoxy(80,17);printf("correcto");
cont1c=cont1c+1;
}
else
{
system("color 0C");
gotoxy(80,17);printf("incorrecto");
cont2i=cont2i+1;
}
for(x=0;x<=30000;x++)
{
...
Obj4()
{
int cont=0,cont1=0,x,a1,a2,a3,r,r1,h;
gotoxy(30,5);printf("AREA,PERIMETRO Y SEMIPERIMETRO DE TRIANGULOS.");
gotoxy(5,6);printf("PERIMETRO:");
gotoxy(5,7);printf("Es la suma de los lados de un poligono:P=a+b+c");
gotoxy(5,9);printf("SEMIPERIMETRO:");
gotoxy(5,10);printf("Es la mitad del valor del perimetro encontrado:p=P/2");
gotoxy(5,12);printf("AREA:");
gotoxy(5,13);printf("Es la parte interna de una figura conocida tambien como superficie(su formula varia segun");
gotoxy(5,13);printf("el poligono)en el caso del triangulo: A=(b*h)/2");
gotoxy(53,25);printf("Presione cualquier tecla para continuar...");
getch();
while(cont!=1)
{
...
gotoxy(30,5);printf("AREA,PERIMETRO Y SEMIPERIMETRO DE TRIANGULOS.");
gotoxy(45,6);printf("EJERCICIOS");
gotoxy(5,7);printf("Instrucciones:Obten los siguientes resultados de Perimetro,Semiperimetro y Area(enteros)");
srand(time(NULL));
a1=rand()%100;
a2=rand()%100;
a3=rand()%100;
h=rand()%100;
gotoxy(5,9);printf("Lado 1:%i Lado 2:%i Lado 3:%i Haltura:%i",a1,a2,a3,h);
gotoxy(5,11);printf("P=%i+%i+%i=",a1,a2,a3);
gotoxy(18,11);scanf("%i",&r);
r1=a1+a2+a3;
if(r==r1)
{
system("color 0A");
...
system("color 0B");
gotoxy(5,13);printf("p=%i/2=",r1);
gotoxy(18,13);scanf("%i",&r);
r1=r1/2;
if(r==r1)
{
system("color 0A");
...
system("color 0B");
gotoxy(5,15);printf("A=(%i*%i)/2=",a1,h);
gotoxy(18,15);scanf("%i",&r);
r1=(a1*h)/2;
if(r==r1)
{
system("color 0A");
...
{
system("color 0B");
gotoxy(5,25);printf("Bien Hecho!... :)");
cont=cont+1;
}
else
{
system("color 0C");
gotoxy(5,25);printf("Buelve a intentarlo...");
}
for(x=0;x<=30000;x++)
{
gotoxy(5,30);
